...
<html lang="tr">
	<head><base href=""/>
		<title>Scobject Muhasebe | Hesaplarınız Güvende, İşiniz Hızlı!</title>
		<meta charset="utf-8" />
        <meta name="description" content="Scobject Muhasebe canlı. Muhasebe programımızın tüm özelliklerini keşfedin. Güçlü raporlama, güvenli veri yönetimi ve kullanıcı dostu arayüz." />
        <meta name="keywords" content="Scobject, muhasebe programı, muhasebe yazılımı, finans yönetimi, işletme muhasebe sistemi, kolay muhasebe, ScObject muhasebe yazılımı" />
						...
						<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
							...
							<div id="kt_app_footer" class="app-footer align-items-center justify-content-center justify-content-md-between flex-column flex-md-row py-3 py-lg-6">
								<div class="text-dark order-2 order-md-1">
									...
									<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Scobject Dijital Yazılım Şirketi</a>
								</div>
								<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
									<li class="menu-item">
										<a href="https://keenthemes.com" target="_blank" class="menu-link px-2">Dokumantasyon</a>
									</li>
									<li class="menu-item">
										<a href="https://devs.keenthemes.com" target="_blank" class="menu-link px-2">Destek Talebi</a>
									</li>
									<li class="menu-item">
										<a href="https://keenthemes.com/products/oswald-html-pro" target="_blank" class="menu-link px-2">S.S.S</a>
									</li>
								</ul>
							</div>
						</div>
